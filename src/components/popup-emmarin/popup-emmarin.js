...
import "./popup-emmarin.scss";

class PopupEmmarin extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <div className="wrapper-popup-emmarin">
        ...
        <div className="wrapper-popup__right-block">
          <div className="wrapper-popup__right-block-header">
            ...
            <Link to='/turnstile' onClick={this.closeModal} className="wrapper-popup__right-block-header__close-modal"></Link>
          </div>
