            ...
            <div className='wrapper-popup'>
                ...
                <div className='wrapper-popup__right-block'>
                    <div className='wrapper-popup__right-block-header'>
                        ...
                        <div className='wrapper-popup__right-block-header__characteristics'>
                            ...
                            {characteristics === false
                                ...
                                : (<span onClick={this.toggleCharacteristics}>ПОКАЗАТЬ ОПИСАНИЕ</span>)
                            }
                        </div>
                        <div onClick={this.closeModal} className='wrapper-popup__right-block-header__close-modal'></div>
                    </div>
                        ...
                        {characteristics === false
                            ...
                            (
                                <div className='wrapper-popup__right-block-main__description'>
                                    Модуль биометрической идентификации по отпечаткам пальцев гарантирует надежный контроль доступа на территорию для авторизованного персонала.
                                    Встраиваемые модули биометрической идентификации «FRE-02» и «FRM-02» предназначены для обеспечения доступа через турникеты авторизованным пользователям посредством сканирования отпечатков пальцев. 
                                    Также, в виде дополнительной возможности, в данные модули встроены RFID считыватели стандартов Em-Marine или MiFare.
                                </div>
                            ) : (
                                <div className='wrapper-popup__right-block-main__characteristics'>
                                    ...
                                    <div className='wrapper-popup__right-block-main__characteristics__wrapper-options'>
                                        <div>Значение коэффициента ложного отказа в обслуживании:</div>
                                        <div>{'<0.001%'}</div>
                                    </div>
                                    <div className='wrapper-popup__right-block-main__characteristics__wrapper-options'>
                                        <div>Значение коэффициента ложного отказа в обслуживании:</div>
                    ...
                    <div className='wrapper-popup__right-block-footer'>
                        ...
                        <div className='wrapper-popup__right-block__footer__button'>Добавить</div>
                    </div>
                </div>
            </div>
        )
